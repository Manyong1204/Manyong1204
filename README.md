...
| Company | Period | Main Work |
| :--- | :---: | :--- |
| **㈜지지푸드** | 2023.12 ~ 2025.10 | 자금일보 작성, 매입·매출 마감, 세금계산서 발행, 부가세 신고, 미수금 관리, 손익 보고서 작성, 출고 일정 관리 |
| **에프에이지니어스** | 2022.04 ~ 2022.09 | 법인카드 관리, 지출결의서 작성, 세금계산서 발행, 부가세 신고 자료 정리 |
| **인성저축은행** | 2015.03 ~ 2018.03 | 자체 기장, 법인카드 및 공과금 관리, 외부감사 대응, 비품 및 문서 관리 |

#### Data-Relevant Experience

- 입출금 내역, 증빙자료, 세금계산서, 카드 사용 내역을 대조하며 데이터 정합성 검토
- 거래처별 결제일과 미수금 현황을 관리하여 입금 지연 및 신용 리스크 대응
- 월별 손익 보고서 작성 과정에서 매출·매입 흐름과 비용 변동 내역 정리
- 외부감사 대응 시 전표, 계약서, 세금계산서, 입출금 증빙 등 요청 자료를 항목별로 정리
